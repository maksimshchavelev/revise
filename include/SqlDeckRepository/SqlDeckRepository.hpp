...
class SqlDeckRepository : public QObject, public IDeckRepository {
  ...
  public:
    ...
    std::expected<void, QString> update_card_backs_batch(const QVector<CardBackUpdate>& cards) override;
    ...
    std::expected<Card, QString> get_card(int cardId) override;
    std::expected<void, QString> remove_card(int cardId) override;
