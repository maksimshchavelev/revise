...
/**
 * @brief Imports the Anki deck. Only reads it and returns the result. The calling code must place the decks and cards
 * in the database itself.
 */
class AnkiDeckImporter final : public core::IDeckImporter {
  public:
    /**
